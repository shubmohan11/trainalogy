      ...
      <div className="container footer-inner">
        ...
        <div className="footer-brand">
          ...
          <div className="footer-contact">
            <a href="https://www.google.com/maps/place/Dubai" target="_blank" rel="noopener noreferrer" className="contact-item">
        ...
        <div className="footer-newsletter">
          ...
          <div className="footer-social">
            ...
            <a href="https://www.instagram.com/trainology_dxb?igsh=cWNncXF6MjdweW9l" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
